...
to (1,3,0). Your algorithm should work even if it isimplemented in a
language that hasfinite-precision arithmetic.
...
9999 + 3
10002 (carries to left the shift to 0 on all numbers except last
- also, increases size of the array - if allowed, can use list or arraylist,
if not have to copy numbers - array deep copy)
...
def increment_number(nums):
    ...
    # Loop elements in array, starting from the back,
    # and replace the 10s with addition result
